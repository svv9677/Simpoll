<?
	...
	{
		$redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . str_replace('create.php', 'index.php', $_SERVER['REQUEST_URI']);
...
function checkform()
{
	...
	<form name="theCreateForm" target="_top" onSubmit="return checkform()" action="./index.php?#" method="get">
	...
	<input type="radio" name="show_vote" value="1" checked> Yes
	<input type="radio" name="show_vote" value="0"> No
	</td><td>
